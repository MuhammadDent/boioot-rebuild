...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        try { await db.Database.ExecuteSqlRawAsync("ALTER TABLE FeatureDefinitions ADD COLUMN Icon TEXT"); } catch { }
        ...
        // ── Remap FeatureDefinition groups to 5 business-layer categories ─────
        // Idempotent: runs every startup to keep groups in sync.
        // Groups: marketing | content | business | communication | support
        await db.Database.ExecuteSqlRawAsync(@"
            ...
            UPDATE FeatureDefinitions SET FeatureGroup = 'support'       WHERE Key = 'priority_support'");

        // ── Assign Icon emoji to each FeatureDefinition ───────────────────────
        // Idempotent: safe to re-run; overwrites existing value.
        await db.Database.ExecuteSqlRawAsync(@"
            ...
            UPDATE FeatureDefinitions SET Icon = '🏠' WHERE Key = 'homepage_exposure'");

        // ── Seed PlanFeatures for plans 01–04 (Free/Silver/Gold/Platinum) ─────
        // Uses INSERT OR IGNORE so existing rows survive unchanged.
        // Feature IDs: fd1=analytics fd2=support fd3=featured fd4=project_mgmt
        //              fd5=video fd6=multiple_photos fd7=whatsapp fd8=verified fd9=homepage
        await db.Database.ExecuteSqlRawAsync(@"
            INSERT OR IGNORE INTO PlanFeatures (Id, SubscriptionPlanId, FeatureDefinitionId, IsEnabled, CreatedAt, UpdatedAt)
            VALUES
              -- Free (01): only whatsapp
              ('cf000001-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'fd000001-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf000002-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'fd000002-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf000003-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'fd000003-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf000004-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'fd000004-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf000005-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'fd000005-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf000006-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'fd000006-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf000007-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'fd000007-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf000008-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'fd000008-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf000009-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'fd000009-0000-0000-0000-000000000000', 0, {0}, {0}),
              -- Silver (02): whatsapp + multiple_photos
              ('cf00000a-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'fd000001-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf00000b-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'fd000002-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf00000c-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'fd000003-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf00000d-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'fd000004-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf00000e-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'fd000005-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf00000f-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'fd000006-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf000010-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'fd000007-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf000011-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'fd000008-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf000012-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'fd000009-0000-0000-0000-000000000000', 0, {0}, {0}),
              -- Gold (03): analytics + multiple_photos + whatsapp + verified_badge
              ('cf000013-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'fd000001-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf000014-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'fd000002-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf000015-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'fd000003-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf000016-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'fd000004-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf000017-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'fd000005-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf000018-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'fd000006-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf000019-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'fd000007-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf00001a-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'fd000008-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf00001b-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'fd000009-0000-0000-0000-000000000000', 0, {0}, {0}),
              -- Platinum (04): all enabled
              ('cf00001c-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'fd000001-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf00001d-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'fd000002-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf00001e-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'fd000003-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf00001f-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'fd000004-0000-0000-0000-000000000000', 0, {0}, {0}),
              ('cf000020-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'fd000005-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf000021-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'fd000006-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf000022-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'fd000007-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf000023-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'fd000008-0000-0000-0000-000000000000', 1, {0}, {0}),
              ('cf000024-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'fd000009-0000-0000-0000-000000000000', 1, {0}, {0})",
            nowPlan);

        // ── Seed PlanLimits for plans 01–04 (max_images + max_featured_slots) ─
        // Original limits (max_active_listings/agents/projects) are already seeded.
        // These add the two new limit definitions (add00005, add00006) for all plans.
        // Cleanup: earlier schema used 'cl' prefix which contains 'l' — not a valid hex char.
        // Delete those broken rows so the INSERT OR IGNORE below can insert correct ones.
        await db.Database.ExecuteSqlRawAsync("DELETE FROM PlanLimits WHERE Id LIKE 'cl%'");
        await db.Database.ExecuteSqlRawAsync(@"
            INSERT OR IGNORE INTO PlanLimits (Id, SubscriptionPlanId, LimitDefinitionId, Value, CreatedAt, UpdatedAt)
            VALUES
              -- Free (01)
              ('c2000001-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'add00001-0000-0000-0000-000000000000',  2, {0}, {0}),
              ('c2000002-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'add00002-0000-0000-0000-000000000000',  0, {0}, {0}),
              ('c2000003-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'add00003-0000-0000-0000-000000000000',  0, {0}, {0}),
              ('c2000004-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'add00004-0000-0000-0000-000000000000',  0, {0}, {0}),
              ('c2000005-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'add00005-0000-0000-0000-000000000000',  4, {0}, {0}),
              ('c2000006-0000-0000-0000-000000000000', '00000001-0000-0000-0000-000000000000', 'add00006-0000-0000-0000-000000000000',  0, {0}, {0}),
              -- Silver (02)
              ('c2000007-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'add00001-0000-0000-0000-000000000000',  5, {0}, {0}),
              ('c2000008-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'add00002-0000-0000-0000-000000000000',  0, {0}, {0}),
              ('c2000009-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'add00003-0000-0000-0000-000000000000',  0, {0}, {0}),
              ('c200000a-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'add00004-0000-0000-0000-000000000000',  0, {0}, {0}),
              ('c200000b-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'add00005-0000-0000-0000-000000000000',  8, {0}, {0}),
              ('c200000c-0000-0000-0000-000000000000', '00000002-0000-0000-0000-000000000000', 'add00006-0000-0000-0000-000000000000',  1, {0}, {0}),
              -- Gold (03)
              ('c200000d-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'add00001-0000-0000-0000-000000000000', 20, {0}, {0}),
              ('c200000e-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'add00002-0000-0000-0000-000000000000',  0, {0}, {0}),
              ('c200000f-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'add00003-0000-0000-0000-000000000000',  0, {0}, {0}),
              ('c2000010-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'add00004-0000-0000-0000-000000000000',  0, {0}, {0}),
              ('c2000011-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'add00005-0000-0000-0000-000000000000', 15, {0}, {0}),
              ('c2000012-0000-0000-0000-000000000000', '00000003-0000-0000-0000-000000000000', 'add00006-0000-0000-0000-000000000000',  5, {0}, {0}),
              -- Platinum (04)
              ('c2000013-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'add00001-0000-0000-0000-000000000000', -1, {0}, {0}),
              ('c2000014-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'add00002-0000-0000-0000-000000000000',  0, {0}, {0}),
              ('c2000015-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'add00003-0000-0000-0000-000000000000',  0, {0}, {0}),
              ('c2000016-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'add00004-0000-0000-0000-000000000000',  0, {0}, {0}),
              ('c2000017-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'add00005-0000-0000-0000-000000000000', 25, {0}, {0}),
              ('c2000018-0000-0000-0000-000000000000', '00000004-0000-0000-0000-000000000000', 'add00006-0000-0000-0000-000000000000', 20, {0}, {0})",
            nowPlan);

        // ── Seed PlanLimits add00005/add00006 for plans 05–09, 0a, 0b ─────────
        // Auto-populate will handle these but seeding gives realistic defaults.
        await db.Database.ExecuteSqlRawAsync(@"
            INSERT OR IGNORE INTO PlanLimits (Id, SubscriptionPlanId, LimitDefinitionId, Value, CreatedAt, UpdatedAt)
            VALUES
              -- OwnerPro (05): 10 images, 0 featured
              ('cl000019-0000-0000-0000-000000000000', '00000005-0000-0000-0000-000000000000', 'add00005-0000-0000-0000-000000000000', 10, {0}, {0}),
              ('cl00001a-0000-0000-0000-000000000000', '00000005-0000-0000-0000-000000000000', 'add00006-0000-0000-0000-000000000000',  2, {0}, {0}),
              -- BrokerPro (06): 15 images, 5 featured
              ('cl00001b-0000-0000-0000-000000000000', '00000006-0000-0000-0000-000000000000', 'add00005-0000-0000-0000-000000000000', 15, {0}, {0}),
              ('cl00001c-0000-0000-0000-000000000000', '00000006-0000-0000-0000-000000000000', 'add00006-0000-0000-0000-000000000000',  5, {0}, {0}),
              -- BrokerPremium (07): 20 images, 15 featured
              ('cl00001d-0000-0000-0000-000000000000', '00000007-0000-0000-0000-000000000000', 'add00005-0000-0000-0000-000000000000', 20, {0}, {0}),
              ('cl00001e-0000-0000-0000-000000000000', '00000007-0000-0000-0000-000000000000', 'add00006-0000-0000-0000-000000000000', 15, {0}, {0}),
              -- OfficeStarter (08): 20 images, 20 featured
              ('cl00001f-0000-0000-0000-000000000000', '00000008-0000-0000-0000-000000000000', 'add00005-0000-0000-0000-000000000000', 20, {0}, {0}),
              ('cl000020-0000-0000-0000-000000000000', '00000008-0000-0000-0000-000000000000', 'add00006-0000-0000-0000-000000000000', 20, {0}, {0}),
              -- OfficeGrowth (09): unlimited
              ('cl000021-0000-0000-0000-000000000000', '00000009-0000-0000-0000-000000000000', 'add00005-0000-0000-0000-000000000000', 25, {0}, {0}),
              ('cl000022-0000-0000-0000-000000000000', '00000009-0000-0000-0000-000000000000', 'add00006-0000-0000-0000-000000000000', -1, {0}, {0}),
              -- DeveloperBusiness (0a): 25 images, 30 featured
              ('cl000023-0000-0000-0000-000000000000', '0000000a-0000-0000-0000-000000000000', 'add00005-0000-0000-0000-000000000000', 25, {0}, {0}),
              ('cl000024-0000-0000-0000-000000000000', '0000000a-0000-0000-0000-000000000000', 'add00006-0000-0000-0000-000000000000', 30, {0}, {0}),
              -- DeveloperPremium (0b): unlimited
              ('cl000025-0000-0000-0000-000000000000', '0000000b-0000-0000-0000-000000000000', 'add00005-0000-0000-0000-000000000000', -1, {0}, {0}),
              ('cl000026-0000-0000-0000-000000000000', '0000000b-0000-0000-0000-000000000000', 'add00006-0000-0000-0000-000000000000', -1, {0}, {0})",
            nowPlan);
