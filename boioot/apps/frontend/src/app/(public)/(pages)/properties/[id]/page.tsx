        ...
        <div className="detail-grid">
          ...
          <div>
            ...
            <div className="contact-section" style={{ background: "var(--color-bg-card)", border: "1px solid var(--color-border)", borderRadius: "var(--radius-lg)", padding: "1.25rem", marginBottom: "1rem" }}>
              ...
              {/* ── Contact CTA section — ALL THREE buttons always rendered ── */}
              <div style={{ marginBottom: "0.75rem" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                  ...
                  {/* 1 ── المراسلة عبر التطبيق — BLUE #1D4ED8
                      Shown to all non-owner visitors; openChat handles auth gate */}
                  {!isOwn && (
                    <button
                      type="button"
                  ...
                  {/* 2 ── التواصل عبر واتساب — GREEN #16A34A */}
                  {property.ownerPhone && (
                    <a
                      href={waLink(
                        property.ownerPhone,
                  ...
                  {/* 3 ── إظهار رقم الهاتف — neutral outlined */}
                  {property.ownerPhone && (
